...
## Project Structure
    ...
    ├── lilburn_shoe_lift_c_37640  # Django project configurations
...
1. Clone this repo and `cd lilburn_shoe_lift_c_37640`
...
2. Clone this repo and `cd lilburn_shoe_lift_c_37640`
